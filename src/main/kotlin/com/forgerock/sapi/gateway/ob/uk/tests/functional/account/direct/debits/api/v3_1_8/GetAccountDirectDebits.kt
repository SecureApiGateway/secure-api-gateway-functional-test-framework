...
class GetAccountDirectDebits(version: OBVersion, tppResource: CreateTppCallback.TppResource) :
    BaseAccountApi3_1_8(version, tppResource) {
    fun shouldGetAccountDirectDebitsTest(apiClient: ApiClient, apiUnderTest: ApiUnderTest) {
        // Given
