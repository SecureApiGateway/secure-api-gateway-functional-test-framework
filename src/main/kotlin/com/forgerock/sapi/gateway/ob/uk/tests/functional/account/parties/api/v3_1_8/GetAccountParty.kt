...
class GetAccountParty(version: OBVersion, tppResource: CreateTppCallback.TppResource) :
    BaseAccountApi3_1_8(version, tppResource) {

    fun shouldGetAccountPartyTest(apiClient: ApiClient, apiUnderTest: ApiUnderTest) {
        // Given
