...
class GetProducts(version: OBVersion, tppResource: CreateTppCallback.TppResource) :
    BaseAccountApi3_1_8(version, tppResource) {
    fun shouldGetProductsTest(apiClient: ApiClient, apiUnderTest: ApiUnderTest) {
        // Given
        ...
        val result = AccountRS().getAccountsData<OBReadProduct2>(
            accountsApiLinks.GetProducts, accessToken, apiClient
        )
